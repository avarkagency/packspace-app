// Object positions are stored pane-relative, not in viewport coordinates — see CLAUDE.md.
...
/** The grab strip, wider than the 4px rule it draws so it's a comfortable pointer target. */
