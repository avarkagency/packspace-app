...
export function PackBuilderWindow({ inventory, seed, onClose, onCreate }: Props) {
  // state
  ...
  return (
    <div className="fixed inset-0 grid place-items-center p-24" style={{ zIndex: 220 }}>
      ...
      <div className="glass panel-in relative overflow-hidden rounded-16" style={{ width: 720 }}>
        <div className="p-28">
          <h2 className="flex items-center gap-8 text-18 leading-120 tracking-tight text-white">
            <Package className="size-20 text-[#8ee6a8]" />
            Pack Builder
          </h2>
