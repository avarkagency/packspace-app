...
import { chainImage, objectKindLabel, objectTint } from "@/components/desktop/object/ObjectVisual"
...
export function DesktopHover({ items, folders = [] }: { items: DesktopObj[]; folders?: FolderPreview[] }) {
  // refs
